...
public class Exportuseraccounts {
	...
	public static void main(String[] args) {
		...
		c1.findElementByCssSelector("#top-nav > li:nth-child(5) > a").click();
		 ...
		 Select dropdown1 = new Select(c1.findElement(By.id("userAccount")));
...
//		 c1.findElementByCssSelector("#exportButton > button").click();
		 ...
		 WebElement ele = c1.findElement(By.cssSelector("#wrap > div > div.container-fluid.p10.pt0.main-panel.export-session > div > div > panel > div > div.panel-body > form > div > div.form-group.row.export > div:nth-child(2) > div > label.ng-scope.icheck-label > div > ins"));
		 ...
		 c1.findElementByXPath("/html/body/div[3]/div/div[2]/div/div/div/div[2]/div/div/panel/div/div[2]/form/div/div[1]/div[5]/div/label[1]/div/ins").click();
	//	 c1.findElementByXPath("/html/body/div[3]/div/div[2]/div/div/div/div[2]/div/div/panel/div/div[2]/form/div/div[1]/div[5]/div/label[2]/div/ins").click();
