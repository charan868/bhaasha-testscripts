...
public class Sessionshome {
 ...
 //LANGUAGE
		 ...
		 c1.findElementByCssSelector("#wrap > div > div.container-fluid.p10.pt0.main-panel.sessions-panel > panel > div > div.panel-body > form > div > div:nth-child(2) > div:nth-child(1) > sc-select > div.ng-scope > div > ul > li > input").sendKeys("Azeri");
		 ...
		 c1.findElementByCssSelector("#wrap > div > div.container-fluid.p10.pt0.main-panel.sessions-panel > panel > div > div.panel-body > form > div > div:nth-child(2) > div:nth-child(2) > sc-select > div.ng-scope > div > ul > li > input").sendKeys("nunna");
		 ...
		 c1.findElementByCssSelector("#wrap > div > div.container-fluid.p10.pt0.main-panel.sessions-panel > panel > div > div.panel-body > form > div > div:nth-child(2) > div:nth-child(3) > sc-select > div.ng-scope > div > ul > li > input").sendKeys("Telephone");
