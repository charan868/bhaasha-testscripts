...
public class Newbillingtemplate {
	...
	public static void main(String[] args) {
		...
		c1.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div[1]/div/div/div/form/div[3]/div/button")).click();
		 ...
		 c1.findElement(By.xpath("//*[@id=\"page-heading\"]/div/div/button")).click();
		// c1.findElementByName("templateName").click();
		 ...
		 Select dropdown1 = new Select(c1.findElement(By.name("interpreterGroup")));
				 dropdown1.selectByVisibleText("mamatha interpreter");
		 c1.findElementByName("costPerHrInperson").click();
		 c1.findElementByName("costPerHrInperson").sendKeys("20");
		 c1.findElementByName("costPerMinTelephone").click();
		 c1.findElementByName("costPerMinTelephone").sendKeys("20");
		 c1.findElementByName("costPerMinVideo").click();
		 c1.findElementByName("costPerMinVideo").sendKeys("20");
		 c1.findElementByName("costPerHrMediation").click();
		 c1.findElementByName("costPerHrMediation").sendKeys("20");
		 c1.findElementByName("costPerHrCourse").click();
		 c1.findElementByName("costPerHrCourse").sendKeys("20");
		 c1.findElementByName("minBillingTimeInMinInperson").click();
		 c1.findElementByName("minBillingTimeInMinInperson").sendKeys("20");
		 c1.findElementByName("minBillingTimeInMinVoice").click();
		 c1.findElementByName("minBillingTimeInMinVoice").sendKeys("20");
		 c1.findElementByName("minBillingTimeInMinVideo").click();
		 c1.findElementByName("minBillingTimeInMinVideo").sendKeys("20");
		 c1.findElementByName("minBillingTimeInMinMediation").click();
		 c1.findElementByName("minBillingTimeInMinMediation").sendKeys("20");
	
		 c1.findElementByName("minBillingTimeInMinCourse").click();
		 c1.findElementByName("minBillingTimeInMinCourse").sendKeys("20");
		 c1.findElementByName("minBillingCostInperson").click();
		 c1.findElementByName("minBillingCostInperson").sendKeys("20");
		 c1.findElementByName("minBillingCostVoice").click();
		 c1.findElementByName("minBillingCostVoice").sendKeys("20");
		 c1.findElementByName("minBillingCostVideo").click();
		 c1.findElementByName("minBillingCostVideo").sendKeys("20");
		 c1.findElementByName("minBillingCostMediation").click();
		 c1.findElementByName("minBillingCostMediation").sendKeys("20");
		 c1.findElementByName("minBillingCostCourse").click();
