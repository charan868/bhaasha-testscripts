...
public class Updatebillingtemplate {
	...
	//	 c1.findElementByCssSelector("#\\31 597312115572-0-uiGrid-00VB-cell > a:nth-child(2) > i").click();
	//	 c1.findElement(By.xpath("//*[@id=\"1597312115572-0-uiGrid-00VB-cell\"]/a[2]/i")).click();
