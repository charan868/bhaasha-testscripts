...
public class InterculturalMediation {
	...
	c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div:nth-child(1) > div:nth-child(5) > sc-select > div.ng-scope > div > ul > li > input")).click();
	c1.findElement(By.cssSelector("#ui-select-choices-row-23-0")).click();
	 c1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div > div:nth-child(5) > sc-select > div.ng-scope > div > div > div > input")).sendKeys("charan chowdary");
	...
	Select dropdown4 = new Select(c1.findElement(By.name("duration")));
	 ...
	 c1.findElement(By.xpath("//input[@placeholder='Select User']")).click();
//	 c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div:nth-child(1) > div:nth-child(9) > div > sc-select > div.ng-scope > div > a > span.select2-chosen.ng-binding")).click();
