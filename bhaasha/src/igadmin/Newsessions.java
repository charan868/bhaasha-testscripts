...
public class Newsessions {
	...
	c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div > div:nth-child(5) > sc-select > div.ng-scope > div > div > div > input")).click();
	 c1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div > div:nth-child(5) > sc-select > div.ng-scope > div > div > div > input")).sendKeys("charan");
	c1.findElementByXPath("/html/body/div[8]/div/div/div[1]/div[2]/form/div/div[5]/sc-select/div[2]/div/div/ul/li/ul/li/div").click();
	...
	Select dropdown4 = new Select(c1.findElement(By.name("duration")));
	 ...
	 c1.findElement(By.name("subject")).sendKeys("test");
...
//	 c1.findElementByCssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div:nth-child(1) > div.modal-body > form > div.col-sm-6.ng-scope > sc-select > div.ng-scope > div > a").click();
//	 c1.findElement(By.xpath("/html/body/div[7]/div/div/div[1]/div[2]/form/div[3]/sc-select/div[2]/div/div/ul/li/ul/li[1]/div")).click();
	 
	 c1.findElement(By.cssSelector("body > div.modal.fade.ng-isolate-scope.in > div > div > div.modal-footer.ng-scope > button.btn.btn-primary.ng-binding.ng-scope")).click();
