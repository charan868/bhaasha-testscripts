...
public class Updatebillingruletemplate {
	...
	public static void main(String[] args) {
		...
		c1.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div[1]/div/div/div/form/div[3]/div/button")).click();
		 ...
		 c1.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/div/div/div[2]/panel/div/div[2]/div/div[1]/div[3]/div/div[2]/div/div[1]/div/div/a[2]/i")).click();
		c1.findElement(By.name("templateName")).click();
		c1.findElement(By.name("templateName")).clear();
		c1.findElement(By.name("templateName")).sendKeys("noun");
		 ...
		 c1.findElementByName("minTravelDuration").clear();
		 ...
		 c1.findElementByName("weekendFromTimeInHr").clear();
	...
	Select dropdown8 = new Select(c1.findElement(By.name("weekendEndDay")));
		 ...
		 c1.findElementByName("weekendToTimeInHr").clear();
