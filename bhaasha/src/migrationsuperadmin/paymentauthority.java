...
public class paymentauthority {
	...
	//		c1.findElement(By.xpath("/html/body/app-root/horizontal-layout/div/main/div/app-organization/form/tc-card/div/div/div[1]/tc-form-group/tc-select")).click();
		...
		c1.findElementByCssSelector("body > app-root > horizontal-layout > div > main > div > app-view-organization > div:nth-child(10) > div > tc-card > div.card-content > div.row.ng-star-inserted > div > button").click();
		c1.findElement(By.xpath("//input[@placeholder='Label Name']")).sendKeys("pa1");
		c1.findElementByCssSelector("body > app-root > horizontal-layout > div > main > div > app-view-organization > div:nth-child(10) > div > tc-card > div.card-content > form > div > div:nth-child(8) > div > div:nth-child(2) > div:nth-child(3) > tc-form-group > tc-checkbox > div > div.tc-checkbox-handle").click();
		c1.findElement(By.xpath("//input[@placeholder='Enter Option']")).sendKeys("1");
		c1.findElement(By.xpath("//input[@placeholder='Address Number']")).sendKeys("520");
		c1.findElementByCssSelector("body > app-root > horizontal-layout > div > main > div > app-view-organization > div:nth-child(10) > div > tc-card > div.card-content > form > div > div:nth-child(8) > div > div:nth-child(4) > div:nth-child(3) > button").click();
