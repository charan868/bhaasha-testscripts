...
public class Userlogin {
	...
	c1.findElement(By.xpath("/html/body/div[1]/ion-nav-view/ion-view/ion-content/div[1]/div[4]/button[1]")).click();
		...
		c1.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		c1.findElementByXPath("/html/body/div[1]/ion-nav-view/div/ion-nav-view[1]/div/ion-view/ion-content/div[1]/div[2]/form/div[1]/div/div/sc-select/div[2]/div/div/ul/li/ul/li[3]/div").click();
		c1.findElementByCssSelector("body > div:nth-child(1) > ion-nav-view > div > ion-nav-view.left-bar.view-container > div > ion-view > ion-content > div.scroll > div.custom-lang-sec.dashboard-lang.padding.text-center > form > div:nth-child(3) > div > button").click();
